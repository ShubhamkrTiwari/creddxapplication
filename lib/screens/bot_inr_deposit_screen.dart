...
class BotInrDepositScreen extends StatefulWidget {
  const BotInrDepositScreen({super.key});

  @override
  State<BotInrDepositScreen> createState() => _BotInrDepositScreenState();
}

class _BotInrDepositScreenState extends State<BotInrDepositScreen> {
  ...
  Widget _buildDepositHistoryItem(Map<String, dynamic> deposit) {
    ...
    if (createdAt != null) {
      try {
        DateTime date = DateTime.tryParse(createdAt.toString()) ?? DateTime.now();
                  ...
                  children: [
                    ...
                    Text(
                      coin == 'INR' 
                          ...
                          : '${double.tryParse(amount)?.toStringAsFixed(4) ?? amount} $coin',
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
